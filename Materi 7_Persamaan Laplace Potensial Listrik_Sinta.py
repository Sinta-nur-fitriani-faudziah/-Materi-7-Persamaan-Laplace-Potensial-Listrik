...
Original file is located at
    https://colab.research.google.com/drive/155C_UyeZwHurFaPDfiGBCTM8CG2UMEv3
"""
...
for i in range(iters):
  grid_updates = convolve(grid, kern, mode='constant')
  # boundary conditions (neumann)
  grid_updated = neumann(grid_updates)
...
plt.semilogy(np.sqrt(np.array(err)), label='Good Geuss')
